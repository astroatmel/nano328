...
PROGMEM const unsigned long pgm_stars_pos[] = // The next 85 stars are used for polar alignment : they are reference stars
   {
   (  0*TICKS_P_HOUR + 8*TICKS_P_MIN +23.259*TICKS_P_SEC ),( 29*TICKS_P_DEG + 5*TICKS_P_DEG_MIN + 25.56*TICKS_P_DEG_SEC), //   0 21alp And  
   (  0*TICKS_P_HOUR +13*TICKS_P_MIN +14.153*TICKS_P_SEC ),( 15*TICKS_P_DEG +11*TICKS_P_DEG_MIN +  0.95*TICKS_P_DEG_SEC), //   1 88gam Peg  
   (  0*TICKS_P_HOUR +43*TICKS_P_MIN +35.371*TICKS_P_SEC ),(342*TICKS_P_DEG + 0*TICKS_P_DEG_MIN + 48.22*TICKS_P_DEG_SEC), //   2 16bet Cet      -17 59 11.78 
   (  1*TICKS_P_HOUR + 9*TICKS_P_MIN +43.924*TICKS_P_SEC ),( 35*TICKS_P_DEG +37*TICKS_P_DEG_MIN + 14.01*TICKS_P_DEG_SEC), //   3 43bet And  
   (  1*TICKS_P_HOUR +54*TICKS_P_MIN +38.409*TICKS_P_SEC ),( 20*TICKS_P_DEG +48*TICKS_P_DEG_MIN + 28.93*TICKS_P_DEG_SEC), //   4 6bet Ari  
   (  2*TICKS_P_HOUR + 3*TICKS_P_MIN +53.953*TICKS_P_SEC ),( 42*TICKS_P_DEG +19*TICKS_P_DEG_MIN + 47.01*TICKS_P_DEG_SEC), //   5 57gam1 And  
   (  2*TICKS_P_HOUR + 7*TICKS_P_MIN +10.407*TICKS_P_SEC ),( 23*TICKS_P_DEG +27*TICKS_P_DEG_MIN + 44.72*TICKS_P_DEG_SEC), //   6 13alp Ari  
   (  3*TICKS_P_HOUR + 2*TICKS_P_MIN +16.772*TICKS_P_SEC ),(  4*TICKS_P_DEG + 5*TICKS_P_DEG_MIN + 23.04*TICKS_P_DEG_SEC), //   7 92alp Cet  
   (  3*TICKS_P_HOUR + 8*TICKS_P_MIN +10.132*TICKS_P_SEC ),( 40*TICKS_P_DEG +57*TICKS_P_DEG_MIN + 20.33*TICKS_P_DEG_SEC), //   8 26bet Perceus  
   (  3*TICKS_P_HOUR +24*TICKS_P_MIN + 19.37*TICKS_P_SEC ),( 49*TICKS_P_DEG +51*TICKS_P_DEG_MIN + 40.25*TICKS_P_DEG_SEC), //   9 33alp Perceus  
   (  3*TICKS_P_HOUR +47*TICKS_P_MIN +29.077*TICKS_P_SEC ),( 24*TICKS_P_DEG + 6*TICKS_P_DEG_MIN + 18.49*TICKS_P_DEG_SEC), //  10 25eta Taurus  
   ...
   (  3*TICKS_P_HOUR +58*TICKS_P_MIN + 1.766*TICKS_P_SEC ),(346*TICKS_P_DEG +29*TICKS_P_DEG_MIN + 29.35*TICKS_P_DEG_SEC), //  13 34gam Eri      -13 30 30.65 
   (  4*TICKS_P_HOUR +35*TICKS_P_MIN +55.239*TICKS_P_SEC ),( 16*TICKS_P_DEG +30*TICKS_P_DEG_MIN + 33.48*TICKS_P_DEG_SEC), //  14 87alp Taurus  
   (  4*TICKS_P_HOUR +56*TICKS_P_MIN +59.619*TICKS_P_SEC ),( 33*TICKS_P_DEG + 9*TICKS_P_DEG_MIN + 57.92*TICKS_P_DEG_SEC), //  15 3iot Aur  
   (  5*TICKS_P_HOUR + 7*TICKS_P_MIN +50.985*TICKS_P_SEC ),(354*TICKS_P_DEG +54*TICKS_P_DEG_MIN + 48.79*TICKS_P_DEG_SEC), //  16 67bet Eri      -05 05 11.21 
   ...
   (  5*TICKS_P_HOUR +16*TICKS_P_MIN +41.359*TICKS_P_SEC ),( 45*TICKS_P_DEG +59*TICKS_P_DEG_MIN + 52.77*TICKS_P_DEG_SEC), //  18 13alp Aur  
   ...
   (  5*TICKS_P_HOUR +59*TICKS_P_MIN +31.723*TICKS_P_SEC ),( 44*TICKS_P_DEG +56*TICKS_P_DEG_MIN + 50.76*TICKS_P_DEG_SEC), //  29 34bet Aur  
   (  5*TICKS_P_HOUR +59*TICKS_P_MIN +43.269*TICKS_P_SEC ),( 37*TICKS_P_DEG +12*TICKS_P_DEG_MIN + 45.31*TICKS_P_DEG_SEC), //  30 37the Aur  
   ...
   ( 10*TICKS_P_HOUR +19*TICKS_P_MIN +58.355*TICKS_P_SEC ),( 19*TICKS_P_DEG +50*TICKS_P_DEG_MIN + 29.36*TICKS_P_DEG_SEC), //  43 41gam1 Leo  
   ( 11*TICKS_P_HOUR + 9*TICKS_P_MIN +39.808*TICKS_P_SEC ),( 44*TICKS_P_DEG +29*TICKS_P_DEG_MIN + 54.55*TICKS_P_DEG_SEC), //  44 52psi UMa  
   ( 11*TICKS_P_HOUR +14*TICKS_P_MIN + 6.501*TICKS_P_SEC ),( 20*TICKS_P_DEG +31*TICKS_P_DEG_MIN + 25.38*TICKS_P_DEG_SEC), //  45 68del Leo  
   ( 11*TICKS_P_HOUR +49*TICKS_P_MIN + 3.578*TICKS_P_SEC ),( 14*TICKS_P_DEG +34*TICKS_P_DEG_MIN + 19.42*TICKS_P_DEG_SEC), //  46 94bet Leo  
   ...
   ( 12*TICKS_P_HOUR +41*TICKS_P_MIN +39.642*TICKS_P_SEC ),(358*TICKS_P_DEG +33*TICKS_P_DEG_MIN +  2.25*TICKS_P_DEG_SEC), //  49 29gam Vir      -01 26 57.75 
   ( 12*TICKS_P_HOUR +56*TICKS_P_MIN + 1.667*TICKS_P_SEC ),( 38*TICKS_P_DEG +19*TICKS_P_DEG_MIN +  6.17*TICKS_P_DEG_SEC), //  50 12alp2 CVn  
   ( 13*TICKS_P_HOUR + 2*TICKS_P_MIN +10.597*TICKS_P_SEC ),( 10*TICKS_P_DEG +57*TICKS_P_DEG_MIN + 32.94*TICKS_P_DEG_SEC), //  51 47eps Vir  
   ( 13*TICKS_P_HOUR +25*TICKS_P_MIN +11.579*TICKS_P_SEC ),(348*TICKS_P_DEG +50*TICKS_P_DEG_MIN + 19.24*TICKS_P_DEG_SEC), //  52 67alp Vir      -11 09 40.76 
   ( 13*TICKS_P_HOUR +47*TICKS_P_MIN +32.438*TICKS_P_SEC ),( 49*TICKS_P_DEG +18*TICKS_P_DEG_MIN + 47.75*TICKS_P_DEG_SEC), //  53 85eta UMa  
   ( 13*TICKS_P_HOUR +54*TICKS_P_MIN +41.079*TICKS_P_SEC ),( 18*TICKS_P_DEG +23*TICKS_P_DEG_MIN + 51.78*TICKS_P_DEG_SEC), //  54 8eta Boo  
   ( 14*TICKS_P_HOUR +15*TICKS_P_MIN +39.672*TICKS_P_SEC ),( 19*TICKS_P_DEG +10*TICKS_P_DEG_MIN + 56.69*TICKS_P_DEG_SEC), //  55 16alp Boo  
   ( 14*TICKS_P_HOUR +44*TICKS_P_MIN +59.218*TICKS_P_SEC ),( 27*TICKS_P_DEG + 4*TICKS_P_DEG_MIN +  27.2*TICKS_P_DEG_SEC), //  56 36eps Boo  
   ...
   ( 15*TICKS_P_HOUR +44*TICKS_P_MIN +16.075*TICKS_P_SEC ),(  6*TICKS_P_DEG +25*TICKS_P_DEG_MIN + 32.26*TICKS_P_DEG_SEC), //  60 24alp Ser  
   ...
   ( 19*TICKS_P_HOUR +46*TICKS_P_MIN + 15.58*TICKS_P_SEC ),( 10*TICKS_P_DEG +36*TICKS_P_DEG_MIN + 47.74*TICKS_P_DEG_SEC), //  73 50gam Aquila  
   ...
   ( 21*TICKS_P_HOUR +31*TICKS_P_MIN +33.534*TICKS_P_SEC ),(354*TICKS_P_DEG +25*TICKS_P_DEG_MIN + 43.78*TICKS_P_DEG_SEC), //  78 22bet Aqr      -05 34 16.22 
   ( 21*TICKS_P_HOUR +44*TICKS_P_MIN +11.158*TICKS_P_SEC ),(  9*TICKS_P_DEG +52*TICKS_P_DEG_MIN + 30.04*TICKS_P_DEG_SEC), //  79 8eps Peg  
   ...
   ( 22*TICKS_P_HOUR + 5*TICKS_P_MIN +47.036*TICKS_P_SEC ),(359*TICKS_P_DEG +40*TICKS_P_DEG_MIN + 48.54*TICKS_P_DEG_SEC), //  81 34alp Aqr      -00 19 11.46 
   ( 22*TICKS_P_HOUR +43*TICKS_P_MIN + 0.137*TICKS_P_SEC ),( 30*TICKS_P_DEG +13*TICKS_P_DEG_MIN + 16.48*TICKS_P_DEG_SEC), //  82 44eta Peg  
   ...
   ( 14*TICKS_P_HOUR + 3*TICKS_P_MIN +  13.4*TICKS_P_SEC ),( 54*TICKS_P_DEG +20*TICKS_P_DEG_MIN +    57*TICKS_P_DEG_SEC), //  99 >M101
